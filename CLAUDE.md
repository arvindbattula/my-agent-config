...
- `hooks/` — Session lifecycle hooks (session-start, compress-memory, design-antipattern-check, design-antipattern-prevent, protect-paths, command-policy, stop-gate, session-end)
