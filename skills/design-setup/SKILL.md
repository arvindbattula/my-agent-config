---
name: design-setup
description: "Teach AI deep design principles and set up project design context. Use when starting frontend work on a new project, when design output looks generic or 'AI-generated', or when any design skill requires project context. Run once per project to establish design direction."
argument-hint: "[teach]"
user-invocable: true
license: "Based on pbakaus/impeccable (Apache 2.0). See https://github.com/pbakaus/impeccable"
---
...
3. **Run /design-setup teach (REQUIRED)**: If neither source has context, you MUST run `/design-setup teach` NOW before doing anything else. Do NOT skip this step. Do NOT attempt to infer context from the codebase instead.
...
If this skill is invoked with the argument "teach" (e.g., `/design-setup teach`), skip all design work above and instead run the teach flow below. This is a one-time setup that gathers design context for the project.
